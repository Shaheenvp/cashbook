...
class _loginState extends State<login> {
  ...
  Future<void> login() async {
    ...
    if (jsonDecode(response.body)['result']=='success') {
      lid=(jsonDecode(response.body)['log_id']);
      print(jsonDecode(response.body)['log_id']);
print('lid:$lid');
     savedata(lid);
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>home(total: total,lid: lid,)), (Route<dynamic> route) => false);
